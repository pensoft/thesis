...
class ctplkfor extends cbase {
	...
	function __construct($pFieldTempl, $debug = false) {
		...
		$this->kfor = new kfor($this->m_pubdata['flds'], $this->getObjTemplate(G_DEFAULT), $this->m_pubdata['method'], $this->m_pubdata['pvformhtml'], $this->m_pubdata['addbackurl'], $this->m_pubdata['setformname']);
