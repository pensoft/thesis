...
/**
 * The view class for the stories show pages
 *
 * @author peterg
 *
 */
class pShow_Page_View extends pBase_Page_View {
	protected $m_displayShowPage;
	function __construct($pData) {
		parent::__construct($pData);
		$this->m_Templs = array(
			G_DEFAULT => 'global.show',
		);
		$this->m_displayShowPage = $pData['display_show_page'];

		$this->m_objectsMetadata['tree_list_templs'] = array(
			'templs' => array(
				G_HEADER   => 'browse.left_head',
				G_ROWTEMPL => 'browse.left_row_show',
				G_FOOTER   => 'browse.left_foot',
				G_NODATA   => 'browse.tree_list_empty'
			)
		);
		
		$this->m_objectsMetadata['stories_list_templs'] = array(
			'templs' => array(
				G_HEADER   => 'browse.stories_list_head',
				G_ROWTEMPL => 'browse.stories_list_row',
				G_FOOTER   => 'browse.stories_list_foot'
			)
		);
		
		$this->m_objectsMetadata['stories_story'] = array(
			'templs'=>array(
		...
		$this->m_objectsMetadata['stories_story_list'] = array(
			'templs'=>array(
				G_DEFAULT => 'stories.show_list',
				G_GALLERY => 'global.empty',
				G_PHOTO => 'stories.showphoto',
				G_GALPHOTO => 'global.empty',
				G_RGALPHOTO => 'global.empty',
