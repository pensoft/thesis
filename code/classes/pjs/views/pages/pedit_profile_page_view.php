 ...
 */
class pEdit_Profile_Page_View extends pBase_Page_View {
	function __construct($pData) {
		parent::__construct($pData);
		$this->m_Templs = array(
			G_DEFAULT => 'global.editprofilepage'
		);
		...
		$this->m_objectsMetadata['my_expertise_form'] = array(
			'templs' => array(
				G_FORM_TEMPLATE     => 'registerfrm.form_my_expertise',
			)
		);
		...
		$this->m_objectsMetadata['register_success_content'] = array(
			'templs' => array(
				G_DEFAULT => 'registerfrm.editstep1success'
			)
		);
	}
