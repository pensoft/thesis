...
<!-- 		</xsl:element> -->
	...
	<xsl:template match="*[@object_id='118']" mode="bodySections">
		...
		<xsl:if test="(./fields/*[@id='316']/value != '') or (./fields/*[@id='318']/value != '') or (./fields/*[@id='319']/value != '') or (./fields/*[@id='317']/value != '') or (./fields/*[@id='320']/value != '')">
			<div class="P-Article-Preview-Block">
				<xsl:attribute name="instance_id"><xsl:value-of select="./@instance_id" /></xsl:attribute>
				<div class="P-Article-Preview-Block-Title"><xsl:value-of select="$lSecTitle"></xsl:value-of></div>
				<div class="P-Article-Preview-Block-Content">
				...
				<div class="P-Article-Preview-Block-Content">
					<span class="P-Article-Preview-Block-Subsection-Title P-Inline">
						<xsl:value-of select="$lEast"></xsl:value-of>
					</span>
					<xsl:text>: </xsl:text>
					<span>
				...
				<div class="P-Article-Preview-Block-Content">
					<span class="P-Article-Preview-Block-Subsection-Title P-Inline">
						<xsl:value-of select="$lSouth"></xsl:value-of>
					</span>
					<xsl:text>: </xsl:text>
					<span>
				...
				<div class="P-Article-Preview-Block-Content">
					<span class="P-Article-Preview-Block-Subsection-Title P-Inline">
						<xsl:value-of select="$lWest"></xsl:value-of>
					</span>
					<xsl:text>: </xsl:text>
					<span>
				...
				<div class="P-Article-Preview-Block-Content">
					<span class="P-Article-Preview-Block-Subsection-Title P-Inline">
						<xsl:value-of select="$lNorth"></xsl:value-of>
					</span>
					<xsl:text>: </xsl:text>
					<span>
	...
	<xsl:template match="*[@object_id='119']" mode="bodySections">
		<xsl:variable name="lSecTitle" select="./@display_name"></xsl:variable>
		<xsl:variable name="lSecSubTitle" select="./fields/*[@id='322']/@field_name"></xsl:variable>
		<xsl:variable name="lClassification" select="./fields/*[@id='323']/@field_name"></xsl:variable>

		<xsl:if test="(./fields/*[@id='322']/value != '') or (./fields/*[@id='323']/*[@value_id &gt; 0])">
			<div class="P-Article-Preview-Block">
				<xsl:attribute name="instance_id"><xsl:value-of select="./@instance_id" /></xsl:attribute>
				<div class="P-Article-Preview-Block-Title"><xsl:value-of select="$lSecTitle"></xsl:value-of></div>
				<div class="P-Article-Preview-Block-Content">
				...
				<div class="P-Article-Preview-Block-Content">
					<span class="P-Article-Preview-Block-Subsection-Title P-Inline">
						<xsl:value-of select="$lClassification"></xsl:value-of>
					</span>
					<xsl:text>: </xsl:text>
					<span>
						<xsl:attribute name="field_id">323</xsl:attribute>
						<xsl:attribute name="class">P-Inline</xsl:attribute>
						<xsl:for-each select="./fields/*[@id='323']/*[@value_id &gt; 0]">
							<xsl:apply-templates select="." mode="formatting_nospace"/>
							<xsl:if test="position()!=last()"><xsl:text>, </xsl:text></xsl:if>
						</xsl:for-each>
					</span>
	...
	<!-- Temporal Coverage -->
	<xsl:template match="*[@object_id='124']" mode="bodySections">
		<xsl:if test="(./fields/*[@id='335']/value != '')">
			<xsl:variable name="lSecTitle" select="./@display_name"></xsl:variable>
			<div class="P-Article-Preview-Block">
				<xsl:attribute name="instance_id"><xsl:value-of select="./@instance_id" /></xsl:attribute>
				<div class="P-Article-Preview-Block-Title"><xsl:value-of select="$lSecTitle"></xsl:value-of></div>
				<div class="P-Article-Preview-Block-Content">
					<span>
						<xsl:attribute name="field_id">335</xsl:attribute>
						<xsl:attribute name="class">P-Inline</xsl:attribute>
						<xsl:apply-templates select="./fields/*[@id='335']/value" mode="formatting"/>
					</span>
				</div>
			</div>
		</xsl:if>
	...
	<xsl:template match="*[@object_id='127']" mode="bodySections">
		...
		<div class="P-Article-Preview-Block">
			...
			<div class="P-Article-Preview-Block-Title"><xsl:value-of select="$lSecTitle"></xsl:value-of></div>
			<div class="P-Article-Preview-Block-Content">
				<xsl:for-each select="$pNode/fields/*[value != '']">
					<xsl:text> [</xsl:text>
						<xsl:apply-templates select="." mode="formatting_nospace"/>
					<xsl:text>]</xsl:text>
					<xsl:if test="position()!=last()"><xsl:text>, </xsl:text></xsl:if>
