...
$gKforFlds = array(	
	...
	'name' => array(
		'VType' => 'string',
		'CType' => 'text',
		'DisplayName' => getstr('pwt_admin.objects.name'),
		'AddTags' => array(
			'class' => 'coolinp',
		),
		'AllowNulls' => true,
	...
	<div class="r">
		...
		<div class="tr">
			<table cellspacing="0" cellpadding="5" border="0" class="formtable">
				...
				<tr>
					<th colspan="2">' . getstr('pwt_admin.objects.filter') . '</th>
				</tr>
				<tr>
					<td>{*name}<br/>{name}</td>					
				</tr>
...
$lListAntets = array(
	1 => array('caption' => getstr('pwt_admin.objects.colID'), 'deforder' => 'desc', 'def'), 
	2 => array('caption' => getstr('pwt_admin.objects.colName'), 'deforder' => 'asc'), 	
			...
			<table cellspacing="0" cellpadding="5" border="0" class="gridtable">
				<tr>
					<th class="gridtools" colspan="10">
						<a href="./edit.php">' . getstr('pwt_admin.objects.addItem') . '</a>
						' . getstr('pwt_admin.objects.antetka') . '
					</th>
				</tr>
';
...
if (!$lList->DisplayList($gListPage)) {
	echo $lTableHeader . '<tr><td colspan="4"><p align="center"><b>' . getstr('pwt_admin.objects.noData') . '</b></p></td></tr>' . $lTableFooter;
}
