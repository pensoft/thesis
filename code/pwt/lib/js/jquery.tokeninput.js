...
$.TokenList = function (input, url_or_data, settings) {
    ...
    if(settings.modal) {
		var dropdown = $("<div>")
			...
			.appendTo("#P-Registration-Content")
			.hide();
	} else {
		var dropdown = $("<div>")
			.addClass(settings.classes.dropdown)
    ...
    function show_dropdown() {
		if(settings.modal) {
			var modalTop = $("#P-Registration-Content").offset().top;
			var modalLeft = $("#P-Registration-Content").offset().left;
			dropdown
				.css({
					position: "absolute",
					top: $(token_list).offset().top + $(token_list).outerHeight() - modalTop,
					left: $(token_list).offset().left - modalLeft,
