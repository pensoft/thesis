...
$gKforFlds = array(	
	...
	'upload_has_errors' => array(
		'VType' => 'int',
		'CType' => 'text',
		'DisplayName' => getstr('admin.eol_export.colUploadHasErrors'),
		'AllowNulls' => true,
	),
	...
	'upload_msg' => array(
		'VType' => 'string',
		'CType' => 'text',
		'DisplayName' => getstr('admin.eol_export.colUploadMsg'),
		'AllowNulls' => true,
	),
	...
	'showedit' => array(
		...
		'Hidden' => true,
		'DisplayName' => '',
		'SQL' => 'SELECT * FROM spEolExport(0, {id}, null, null, null, null)',
	...
	'save' => array(
		...
		'SQL' => 'SELECT * FROM spEolExport(1, {id}, {title}, {article_id}, {xml}, ' . (int) $user->id . ')',
	...
	'delete' => array(
		...
		'SQL' => 'SELECT * FROM spEolExport(3, {id}, null, null, null, null)',
