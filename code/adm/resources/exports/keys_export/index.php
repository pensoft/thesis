	...
	<div class="r">
		...
		<div class="tr">
			<table cellspacing="0" cellpadding="5" border="0" class="formtable">
				...
				<tr>
					<th colspan="2">' . getstr('admin.keys_export.filter') . '</th>
				</tr>
				<tr>
...
<tr>
	...
	<td align="right" nowrap="true">
			<a href="/resources/exports/keys_export/edit.php?tAction=showedit&id={id}"><img src="/img/edit.gif" alt="' . getstr('admin.editLabel') . '" title="' . getstr('admin.editLabel') . '" border="0" /></a>						
			<a href="javascript:if (confirm(\'' . getstr('admin.keys_export.confirmDel') . '\')) { window.location = \'/resources/exports/keys_export/edit.php?id={id}&tAction=delete\';} else {}">
...
$lListAntets = array(
	1 => array('caption' => getstr('admin.keys_export.colID'), 'deforder' => 'desc', 'def'), 
	2 => array('caption' => getstr('admin.keys_export.colTitle'), 'deforder' => 'asc'), 
	3 => array('caption' => getstr('admin.keys_export.colCreateDate'), 'deforder' => 'asc'), 
	4 => array('caption' => getstr('admin.keys_export.colLastMod'), 'deforder' => 'asc'), 
	5 => array('caption' => getstr('admin.keys_export.colAuthor'), 'deforder' => 'asc'), 	
			...
			<table cellspacing="0" cellpadding="5" border="0" class="gridtable">
				<tr>
					<th class="gridtools" colspan="10">
						<a href="/resources/exports/keys_export/edit.php">' . getstr('admin.keys_export.addLabel') . '</a>
						' . getstr('admin.keys_export.antetka') . '
					</th>
				</tr>
';
...
if (!$lList->DisplayList($gListPage)) {
	echo $lTableHeader . '<tr><td colspan="8"><p align="center"><b>' . getstr('admin.keys_export.noData') . '</b></p></td></tr>' . $lTableFooter;
}
