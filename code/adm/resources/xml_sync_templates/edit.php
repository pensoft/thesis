...
$gKforFlds = array(	
	...
	'name' => array(
		...
		'DisplayName' => getstr('admin.xml_sync_templates.colName'),
	),
	...
	'showedit' => array(
		...
		'Hidden' => true,
		'DisplayName' => '',
		'SQL' => 'SELECT * FROM spXmlSyncTemplates(0, {id}, null)',
	...
	'save' => array(
		...
		'SQL' => 'SELECT * FROM spXmlSyncTemplates(1, {id}, {name})',
	...
	'delete' => array(
		...
		'SQL' => 'SELECT * FROM spXmlSyncTemplates(3, {id}, null)',
		'ActionMask' => ACTION_CHECK | ACTION_CCHECK | ACTION_EXEC | ACTION_FETCH | ACTION_REDIRECT ,
		'RedirUrl' => '',
		'AddTags' => array(
			'class' => 'frmbutton',			
	...
	'copy' => array(
		...
		'SQL' => 'SELECT * FROM spXmlSyncTemplates(4, {id}, null)',
		'ActionMask' => ACTION_CHECK | ACTION_CCHECK | ACTION_EXEC | ACTION_FETCH | ACTION_REDIRECT ,
...
<div class="r">
	...
	<div class="tr">
		...
		<tr>
			<th colspan="4">' . ((int)$gKfor->lFieldArr['id']['CurValue'] ? getstr('admin.xml_sync_templates.editLabel') : getstr('admin.xml_sync_templates.addLabel') ) . getstr('admin.xml_sync_templates.nameLabel') . '</th>
		</tr>
		<tr>
...
if((int)$gKfor->lFieldArr['id']['CurValue'] ){
	showRelatedSyncDetails((int)$gKfor->lFieldArr['id']['CurValue']);
}
