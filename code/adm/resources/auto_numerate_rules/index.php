...
$gKforFlds = array(	
	...
	'name' => array(
		'VType' => 'string',
		'CType' => 'text',
		'DisplayName' => getstr('admin.auto_numerate_rules.name'),
		'AddTags' => array(
			'class' => 'coolinp',
		),
		'AllowNulls' => true,
	...
	<div class="r">
		...
		<div class="tr">
			<table cellspacing="0" cellpadding="5" border="0" class="formtable">
				...
				<tr>
					<th colspan="2">' . getstr('admin.auto_numerate_rules.filter') . '</th>
				</tr>
				<tr>
					<td>{*name}<br/>{name}</td>					
				</tr>
...
<tr>
	...
	<td align="right" nowrap="true">
			...
			<a href="javascript:if (confirm(\'' . getstr('admin.auto_numerate_rules.ConfirmDel') . '\')) { window.location = \'/resources/auto_numerate_rules/edit.php?id={id}&tAction=delete\';} else {}">
...
$lListAntets = array(
	1 => array('caption' => getstr('admin.auto_numerate_rules.colID'), 'deforder' => 'desc', 'def'), 
	2 => array('caption' => getstr('admin.auto_numerate_rules.colName'), 'deforder' => 'asc'), 
	3 => array('caption' => getstr('admin.auto_numerate_rules.colXPath'), 'deforder' => 'asc'), 	
	4 => array('caption' => getstr('admin.auto_numerate_rules.colAttributeName'), 'deforder' => 'asc'), 
	5 => array('caption' => getstr('admin.auto_numerate_rules.colStartingValue'), 'deforder' => 'asc'), 
			...
			<table cellspacing="0" cellpadding="5" border="0" class="gridtable">
				<tr>
					<th class="gridtools" colspan="10">
						<a href="./edit.php">' . getstr('admin.auto_numerate_rules.addItem') . '</a>
						' . getstr('admin.auto_numerate_rules.antetka') . '
					</th>
				</tr>
';
...
$lListSql = 'SELECT n.id, n.name, n.xpath, n.attribute_name, n.starting_value
FROM auto_numerate_rules n
' . $gListSqlWhere;
//~ echo $lListSql;
...
if (!$lList->DisplayList($gListPage)) {
	echo $lTableHeader . '<tr><td colspan="4"><p align="center"><b>' . getstr('admin.auto_numerate_rules.noData') . '</b></p></td></tr>' . $lTableFooter;
}
