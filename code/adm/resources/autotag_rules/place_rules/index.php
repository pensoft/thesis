...
$gKforFlds = array(	
	...
	'name' => array(
		'VType' => 'string',
		'CType' => 'text',
		'DisplayName' => getstr('admin.place_rules.name'),
		'AddTags' => array(
			'class' => 'coolinp',
		),
		'AllowNulls' => true,
	...
	<div class="r">
		...
		<div class="tr">
			<table cellspacing="0" cellpadding="5" border="0" class="formtable">
				...
				<tr>
					<th colspan="2">' . getstr('admin.place_rules.filter') . '</th>
				</tr>
				<tr>
					<td>{*name}<br/>{name}</td>					
				</tr>
...
<tr>
	...
	<td align="right" nowrap="true">
			...
			<a href="javascript:if (confirm(\'' . getstr('admin.place_rules.ConfirmDel') . '\')) { window.location = \'/resources/place_rules/edit.php?id={id}&tAction=delete\';} else {}">
...
$lListAntets = array(
	1 => array('caption' => getstr('admin.place_rules.colID'), 'deforder' => 'desc', 'def'), 
	2 => array('caption' => getstr('admin.place_rules.colTitle'), 'deforder' => 'asc'), 	
			...
			<table cellspacing="0" cellpadding="5" border="0" class="gridtable">
				<tr>
					<th class="gridtools" colspan="10">
						<a href="./edit.php">' . getstr('admin.place_rules.addPlaceRule') . '</a>
						' . getstr('admin.place_rules.antetka') . '
					</th>
				</tr>
';
...
if (!$lList->DisplayList($gListPage)) {
	echo $lTableHeader . '<tr><td colspan="4"><p align="center"><b>' . getstr('admin.place_rules.noData') . '</b></p></td></tr>' . $lTableFooter;
}
