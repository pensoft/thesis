...
$gKforFlds = array(	
	...
	'name' => array(
		...
		'DisplayName' => getstr('admin.autotag_rules.colName'),
	),
	...
	'showedit' => array(
		...
		'Hidden' => true,
		'DisplayName' => '',
		'SQL' => 'SELECT * FROM spAutotagRules(0, {id}, null)',
	...
	'save' => array(
		...
		'SQL' => 'SELECT * FROM spAutotagRules(1, {id}, {name})',
		'ActionMask' => ACTION_CHECK | ACTION_CCHECK | ACTION_EXEC | ACTION_FETCH | ACTION_REDIRECT ,
		'RedirUrl' => './edit.php?id={id}&tAction=showedit',
		'AddTags' => array(
			'class' => 'frmbutton',			
		), 
	),
	...
	'delete' => array(
		...
		'SQL' => 'SELECT * FROM spAutotagRules(3, {id}, null)',
		'ActionMask' => ACTION_CHECK | ACTION_CCHECK | ACTION_EXEC | ACTION_FETCH | ACTION_REDIRECT ,
		'RedirUrl' => '',
		'AddTags' => array(
			'class' => 'frmbutton',			
	...
	'copy' => array(
		...
		'SQL' => 'SELECT * FROM spAutotagRules(4, {id}, null)',
		'ActionMask' => ACTION_CHECK | ACTION_CCHECK | ACTION_EXEC | ACTION_FETCH | ACTION_REDIRECT ,
		'RedirUrl' => './edit.php?id={id}&tAction=showedit',
		'AddTags' => array(
			'class' => 'frmbutton',			
...
<div class="r">
	...
	<div class="tr">
		...
		<tr>
			<th colspan="4">' . ((int)$gKfor->lFieldArr['id']['CurValue'] ? getstr('admin.autotag_rules.editLabel') : getstr('admin.autotag_rules.addLabel') ) . getstr('admin.autotag_rules.nameLabel') . '</th>
		</tr>
		<tr>
...
if((int)$gKfor->lFieldArr['id']['CurValue'] ){
	showRelatedProperties((int)$gKfor->lFieldArr['id']['CurValue']);
}
