...
$gKforFlds = array(	
	...
	'name' => array(
		'VType' => 'string',
		'CType' => 'text',
		'DisplayName' => getstr('admin.node_split.name'),
		'AddTags' => array(
			'class' => 'coolinp',
		),
		'AllowNulls' => true,
	...
	<div class="r">
		...
		<div class="tr">
			<table cellspacing="0" cellpadding="5" border="0" class="formtable">
				...
				<tr>
					<th colspan="2">' . getstr('admin.node_split.filter') . '</th>
				</tr>
				<tr>
					<td>{*name}<br/>{name}</td>					
				</tr>
...
<tr>
	...
	<td align="right" nowrap="true">
			...
			<a href="javascript:if (confirm(\'' . getstr('admin.node_split.ConfirmDel') . '\')) { window.location = \'/resources/node_split/edit.php?id={id}&tAction=delete\';} else {}">
...
$lListAntets = array(
	1 => array('caption' => getstr('admin.node_split.colID'), 'deforder' => 'desc', 'def'), 
	2 => array('caption' => getstr('admin.node_split.colName'), 'deforder' => 'asc'), 
	3 => array('caption' => getstr('admin.node_split.colXPath'), 'deforder' => 'asc'), 		
			...
			<table cellspacing="0" cellpadding="5" border="0" class="gridtable">
				<tr>
					<th class="gridtools" colspan="10">
						<a href="./edit.php">' . getstr('admin.node_split.addItem') . '</a>
						' . getstr('admin.node_split.antetka') . '
					</th>
				</tr>
';
...
$lListSql = 'SELECT n.id, n.name, n.xpath
FROM node_split n
' . $gListSqlWhere;
//~ echo $lListSql;
...
if (!$lList->DisplayList($gListPage)) {
	echo $lTableHeader . '<tr><td colspan="4"><p align="center"><b>' . getstr('admin.node_split.noData') . '</b></p></td></tr>' . $lTableFooter;
}
