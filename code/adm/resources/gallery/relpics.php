			...
			<table cellspacing="0" cellpadding="5" border="0" class="gridtable">
				<tr>
					<th class="gridtools" colspan="5">
						<a href="javascript:openw(\'/resources/photos/edit.php?storyid=' . $guid . '&place=1&sid=' . (int)$f->lFieldArr['primarysite']['CurValue'] . '\', \'aa\', \'location=no,menubar=yes,width=600,height=400,scrollbars=yes,resizable=yes,top=0,left=0\')">' . getstr('admin.stories.addRelPic') . '</a>
						<div class="gridtools_sep">|</div>
						<a href="javascript:openw(\'/resources/gallery/selphoto.php?storyid=' . $guid . '\', \'aa\', \'location=no,menubar=yes,width=1000,height=700,scrollbars=yes,resizable=yes,top=0,left=0\')">' . getstr('admin.stories.addRelExistingPic') . '</a> 
