...
$gKforFlds = array(	
	...
	'name' => array(
		'VType' => 'string',
		'CType' => 'text',
		'DisplayName' => getstr('admin.xml_nodes.name'),
		'AddTags' => array(
			'class' => 'coolinp',
		),
		'AllowNulls' => true,
	...
	<div class="r">
		...
		<div class="tr">
			<table cellspacing="0" cellpadding="5" border="0" class="formtable">
				...
				<tr>
					<th colspan="2">' . getstr('admin.xml_nodes.filter') . '</th>
				</tr>
				<tr>
					<td>{*name}<br/>{name}</td>					
				</tr>
...
$lWhereArr = array();
//~ $lWhereArr[] = ' n.id BETWEEN 230 AND 233';
...
<tr>
	...
	<td>{createdate}</td>
	<td>{_showAutotagAnnotateShow}</td>
	<td align="right" nowrap="true">
			...
			<a href="javascript:if (confirm(\'' . getstr('admin.xml_nodes.xml_nodeConfirmDel') . '\')) { window.location = \'/resources/xml_nodes/edit.php?id={id}&tAction=delete\';} else {}">
...
$lListAntets = array(
	1 => array('caption' => getstr('admin.xml_nodes.colID'), 'deforder' => 'desc', 'def'), 
	2 => array('caption' => getstr('admin.xml_nodes.colTitle'), 'deforder' => 'asc'), 
	3 => array('caption' => getstr('admin.xml_nodes.colCreateDate'), 'deforder' => 'asc'), 
	4 => array('caption' => getstr('admin.xml_nodes.colAutotagAnnotateShow'), 'deforder' => 'asc'), 
			...
			<table cellspacing="0" cellpadding="5" border="0" class="gridtable">
				<tr>
					<th class="gridtools" colspan="10">
						<a href="./edit.php">' . getstr('admin.xml_nodes.addNode') . '</a>
						' . getstr('admin.xml_nodes.antetka') . '
					</th>
				</tr>
';
...
$lListSql = 'SELECT n.id, date_trunc(\'seconds\', n.createdate) as createdate, n.name, n.autotag_annotate_show
FROM xml_nodes n
' . $gListSqlWhere;
//~ echo $lListSql;
...
if (!$lList->DisplayList($gListPage)) {
	echo $lTableHeader . '<tr><td colspan="4"><p align="center"><b>' . getstr('admin.xml_nodes.noData') . '</b></p></td></tr>' . $lTableFooter;
}
