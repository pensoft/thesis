...
$t = '<tr>
		<td valign="top"><a href="./edit.php?tAction=showedit&guid={relstoryid}" target="_parent">{title}</a></td>
			...
			<table cellspacing="0" cellpadding="5" border="0" class="gridtable">
				<tr>
					<th class="gridtools" colspan="4">
						<a href="javascript:openw(\'./index.php?relstoryid=' . $guid . '&mode=rel\', \'aa\', \'location=no,menubar=yes,width=1000,height=700,scrollbars=yes,resizable=yes,top=0,left=0\')">' . getstr('admin.stories.addRelStory') . '</a>
