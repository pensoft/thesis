...
$gKforFlds = array(	
	...
	'name' => array(
		...
		'DisplayName' => getstr('admin.place_rules.colName'),
	),
	...
	'xpath' => array(
		...
		'DisplayName' => getstr('admin.place_rules.colXPath'),
	),
	...
	'showedit' => array(
		...
		'Hidden' => true,
		'DisplayName' => '',
		'SQL' => 'SELECT * FROM spPlaceRules(0, {id}, null, null)',
	...
	'save' => array(
		...
		'SQL' => 'SELECT * FROM spPlaceRules(1, {id}, {name}, {xpath})',
	...
	'delete' => array(
		...
		'SQL' => 'SELECT * FROM spPlaceRules(3, {id}, null, null)',
		'ActionMask' => ACTION_CHECK | ACTION_CCHECK | ACTION_EXEC | ACTION_FETCH | ACTION_REDIRECT ,
		'RedirUrl' => '',
		'AddTags' => array(
			'class' => 'frmbutton',			
...
<div class="r">
	...
	<div class="tr">
		...
		<tr>
			<th colspan="4">' . ((int)$gKfor->lFieldArr['id']['CurValue'] ? getstr('admin.place_rules.editLabel') : getstr('admin.place_rules.addLabel') ) . getstr('admin.place_rules.nameLabel') . '</th>
		</tr>
		<tr>
