...
if( $gKfor->lCurAction == 'show' && !$gKfor->lErrorCount){
	...
	if( (int)$gKfor->lFieldArr['journal_id']['CurValue']){	
		$lWhereArr[] = ' a.journal_id = ' . (int)$gKfor->lFieldArr['journal_id']['CurValue'];
	}
	
	if( (int)$gKfor->lFieldArr['issue_id']['CurValue']){	
		$lWhereArr[] = ' a.issue_id = ' . (int)$gKfor->lFieldArr['issue_id']['CurValue'];
	}
...
<tr>
	...
	<td align="right" nowrap="true">
			<a href="/resources/eol_export/edit.php?tAction=showedit&id={id}"><img src="/img/edit.gif" alt="' . getstr('admin.editLabel') . '" title="' . getstr('admin.editLabel') . '" border="0" /></a>						
			<a href="javascript:if (confirm(\'' . getstr('admin.eol_export.confirmDel') . '\')) { window.location = \'/resources/eol_export/edit.php?id={id}&tAction=delete\';} else {}">
			...
			<table cellspacing="0" cellpadding="5" border="0" class="gridtable">
				<tr>
					<th class="gridtools" colspan="10">
						<a href="/resources/eol_export/edit.php">' . getstr('admin.eol_export.addLabel') . '</a>
