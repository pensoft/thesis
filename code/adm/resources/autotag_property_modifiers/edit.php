...
$gKforFlds = array(	
	...
	'name' => array(
		...
		'DisplayName' => getstr('admin.autotag_property_modifiers.colName'),
	),
	...
	'showedit' => array(
		...
		'Hidden' => true,
		'DisplayName' => '',
		'SQL' => 'SELECT * FROM spAutotagPropertyModifiers(0, {id}, null)',
	...
	'save' => array(
		...
		'SQL' => 'SELECT * FROM spAutotagPropertyModifiers(1, {id}, {name})',
	...
	'delete' => array(
		...
		'SQL' => 'SELECT * FROM spAutotagPropertyModifiers(3, {id}, null)',
		'ActionMask' => ACTION_CHECK | ACTION_CCHECK | ACTION_EXEC | ACTION_FETCH | ACTION_REDIRECT ,
		'RedirUrl' => '',
		'AddTags' => array(
			'class' => 'frmbutton',			
...
<div class="r">
	...
	<div class="tr">
		...
		<tr>
			<th colspan="4">' . ((int)$gKfor->lFieldArr['id']['CurValue'] ? getstr('admin.autotag_property_modifiers.editLabel') : getstr('admin.autotag_property_modifiers.addLabel') ) . getstr('admin.autotag_property_modifiers.nameLabel') . '</th>
		</tr>
		<tr>
