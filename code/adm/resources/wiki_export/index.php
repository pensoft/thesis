...
<tr>
	...
	<td align="right" nowrap="true">
			<a href="/resources/wiki_export/edit.php?tAction=showedit&id={id}"><img src="/img/edit.gif" alt="' . getstr('admin.editLabel') . '" title="' . getstr('admin.editLabel') . '" border="0" /></a>						
			<a href="javascript:if (confirm(\'' . getstr('admin.wiki_export.confirmDel') . '\')) { window.location = \'/resources/wiki_export/edit.php?id={id}&tAction=delete\';} else {}">
			...
			<table cellspacing="0" cellpadding="5" border="0" class="gridtable">
				<tr>
					<th class="gridtools" colspan="10">
						<a href="/resources/wiki_export/edit.php">' . getstr('admin.wiki_export.addLabel') . '</a>
