...
$gFArr = array(
	1 => array('caption' => 'Потребителско име', 'deforder' => 'asc', 'def'), 
			...
			<table cellspacing="0" cellpadding="5" border="0" class="gridtable">
				<tr>
					<th class="gridtools" colspan="2">
						Потребители включени в тази група
					</th>
				</tr>
';
...
if (!$l->DisplayList()) {
	echo $lTableHeader1 . '<tr><td colspan="2"><p align="center"><b>Няма потребители включени в тази група</b></p></td></tr>' . $lTableFooter;
}
...
if (!$l->DisplayList()) {
	echo $lTableHeader2 . '<tr><td colspan="2"><p align="center"><b>Всички потребители са включени в тази група</b></p></td></tr>' . $lTableFooter;
}
