...
$t = array(
	...
	'name' => array(
		'CType' => 'text',
		'VType' => 'string',
		'DisplayName' => getstr('admin.grp.colNameLabel'),
		'AddTags' => array(
			'class' => 'coolinp',
		),
	),
...
<div class="r">
	...
	<div class="tr">
		...
		<tr>			
			<th colspan="2">' . ((int)$_REQUEST['id'] ? getstr('admin.grp.editLabel') : getstr('admin.grp.addLabel') ) . getstr('admin.grp.nameLabel') . '</th>
		</tr>
		<tr>
			<td><b>{*name}:</b></td>
			<td>{name}</td>
