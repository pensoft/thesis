...
echo '	<form action="./" method="GET">
		...
		<tr><th>Изберете директория</th></tr>
		<tr><td>
...
echo '		</select>
		...
		<input type="submit" class="frmbutton" value="Избери">
		</td></tr>
		</table>
			</div>
			</div>
...
$gFArr1 = array(
	...
	3 => array('caption' => 'Права', 'deforder' => 'asc'), 
			...
			<table cellspacing="0" cellpadding="5" border="0" class="gridtable">
				<tr>
					<th class="gridtools" colspan="3">
						Групи, които имат права в тази директория
					</th>
				</tr>
';
...
if (!$l->DisplayList()) {
	echo $lTableHeader1 . '<tr><td colspan="3"><p align="center"><b>Нито една група няма права в тази директория</b></p></td></tr>' . $lTableFooter;
}
			...
			<table cellspacing="0" cellpadding="5" border="0" class="gridtable">
				<tr>
					<th class="gridtools" colspan="2">
						Групи, които нямат права в тази директория
					</th>
				</tr>
';
...
if (!$l->DisplayList()) {
	echo $lTableHeader2 . '<tr><td colspan="2"><p align="center"><b>Всички групи имат права в тази директория</b></p></td></tr>' . $lTableFooter;
}
