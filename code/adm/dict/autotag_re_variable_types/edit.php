...
$gKforFlds = array(	
	...
	'name' => array(
		...
		'DisplayName' => getstr('admin.autotag_re_variable_types.colName'),
	),
	...
	'showedit' => array(
		...
		'Hidden' => true,
		'DisplayName' => '',
		'SQL' => 'SELECT * FROM spAutotagReVariableTypes(0, {id}, null)',
	...
	'save' => array(
		...
		'SQL' => 'SELECT * FROM spAutotagReVariableTypes(1, {id}, {name})',
	...
	'delete' => array(
		...
		'SQL' => 'SELECT * FROM spAutotagReVariableTypes(3, {id}, null)',
		'ActionMask' => ACTION_CHECK | ACTION_CCHECK | ACTION_EXEC | ACTION_FETCH | ACTION_REDIRECT ,
		'RedirUrl' => '',
		'AddTags' => array(
			'class' => 'frmbutton',			
	...
	'copy' => array(
		...
		'SQL' => 'SELECT * FROM spAutotagReVariableTypes(4, {id}, null)',
		'ActionMask' => ACTION_CHECK | ACTION_CCHECK | ACTION_EXEC | ACTION_FETCH | ACTION_REDIRECT ,
...
<div class="r">
	...
	<div class="tr">
		...
		<tr>
			<th colspan="4">' . ((int)$gKfor->lFieldArr['id']['CurValue'] ? getstr('admin.autotag_re_variable_types.editLabel') : getstr('admin.autotag_re_variable_types.addLabel') ) . getstr('admin.autotag_re_variable_types.nameLabel') . '</th>
		</tr>
		<tr>
