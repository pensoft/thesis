...
$gKforFlds = array(	
	...
	'name' => array(
		'VType' => 'string',
		'CType' => 'text',
		'DisplayName' => getstr('admin.autotag_property_types.name'),
		'AddTags' => array(
			'class' => 'coolinp',
		),
		'AllowNulls' => true,
	...
	<div class="r">
		...
		<div class="tr">
			<table cellspacing="0" cellpadding="5" border="0" class="formtable">
				...
				<tr>
					<th colspan="2">' . getstr('admin.autotag_property_types.filter') . '</th>
				</tr>
				<tr>
					<td>{*name}<br/>{name}</td>					
				</tr>
...
<tr>
	...
	<td align="right" nowrap="true">
			...
			<a href="javascript:if (confirm(\'' . getstr('admin.autotag_property_types.ConfirmDel') . '\')) { window.location = \'/resources/autotag_property_types/edit.php?id={id}&tAction=delete\';} else {}">
...
$lListAntets = array(
	1 => array('caption' => getstr('admin.autotag_property_types.colID'), 'deforder' => 'desc', 'def'), 
	2 => array('caption' => getstr('admin.autotag_property_types.colName'), 'deforder' => 'asc'), 	
			...
			<table cellspacing="0" cellpadding="5" border="0" class="gridtable">
				<tr>
					<th class="gridtools" colspan="10">
						<a href="./edit.php">' . getstr('admin.autotag_property_types.addModifier') . '</a>
						' . getstr('admin.autotag_property_types.antetka') . '
					</th>
				</tr>
';
...
if (!$lList->DisplayList($gListPage)) {
	echo $lTableHeader . '<tr><td colspan="4"><p align="center"><b>' . getstr('admin.autotag_property_types.noData') . '</b></p></td></tr>' . $lTableFooter;
}
