	...
	switch ( listenerName )
	{
		...
		case 'Table' :
			...
			AddItems : function( menu, tag, tagName )
			{
				...
				{
					menu.AddSeparator() ;
					var oItem1 = menu.AddItem('Cell', FCKLang.CellCM);
					oItem1.AddItem('TableInsertCell', FCKLang.InsertCell, 58);
					oItem1.AddItem('TableDeleteCells', FCKLang.DeleteCells, 59);
					oItem1.AddItem('TableMergeCells', FCKLang.MergeCells, 60);
					oItem1.AddItem('TableSplitCell', FCKLang.SplitCell, 61);
					oItem1.AddSeparator();
					oItem1.AddItem('TableCellProp', FCKLang.CellProperties, 57);

					menu.AddSeparator() ;
					var oItem2 = menu.AddItem( 'Row'			, FCKLang.RowCM ) ;
					oItem2.AddItem( 'TableInsertRow'		, FCKLang.InsertRow, 62 ) ;
					oItem2.AddItem( 'TableDeleteRows'	, FCKLang.DeleteRows, 63 ) ;
					
					menu.AddSeparator() ;
					var oItem3 = menu.AddItem( 'Column'		, FCKLang.ColumnCM ) ;
					oItem3.AddItem( 'TableInsertColumn'	, FCKLang.InsertColumn, 64 ) ;
					oItem3.AddItem( 'TableDeleteColumns'	, FCKLang.DeleteColumns, 65 ) ;
				}
				if (bIsTable || bIsCell) {
					menu.AddSeparator() ;
