 ...
 *  version 0.3.1 19/07/2006 (Holger Hees)
 *		-Dreamweaver like modification
 *  
 * 
 * File Authors:
 * 		Alfonso Martínez de Lizarrondo (Uritec) alfonso -at- uritec dot net
 *      Holger Hees hhees -at- systemconcept dot de
 *      quiprodest quiprodest -at- users.sourceforge.net
 *      
 */
...
createStatusBar = function(oStatusBar) {
	...
	while (node && node.nodeName!='BODY') {
		...
		text='&nbsp;<a style="text-decoration:none" href="javascript:selectSBElement(\''+oStatusBar.Instance.Name+'\','+i+')">&lt;'+getNodeName(node)+'&gt;</a>' + text;
	...
	//update the text
	oStatusBar.Bar.innerHTML='<div style="font:10px Verdana">&lt;body&gt;'+text+'</div>';
