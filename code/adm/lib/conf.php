...
define('PATH_CACHE', '/var/www/webs/pensoft.eu/etalig/saso/');
...
define('TAXON_PROFILE_CC_BASEURL',"http://pmt.pensoft.eu/resources/articles/external_details.php?query={taxon_name}");
// URLs
...
define('MEDIAWIKI_EXPORT_TYPE', 6);
define('HTML_NEW_EXPORT_TYPE', 7);
...
define('PENSOFT_ISSUE_EXPORT_URL', 'http://www.pensoft.net/inc/journals/issueExport.php');
define('PENSOFT_ARTICLE_LINK_PATTERN', 'http://www.pensoft.net/inc/journals/download.php?fileId={file_id}&fileTable=J_GALLEYS');
define('BACKUP_PENSOFT_JOURNAL_XMLS', 1);
define('PENSOFT_EOL_EXPORT_APPEND_URL', 'http://www.pensoft.net/tappend/append.php?sourcefilename={sourcefile}&targetfilename={targetfile}');
define('PENSOFT_EOL_EXPORT_APPEND_SUCCESSFUL_REPLY', 'ok');


define('WIKI_ADDRESS', 'http://species-id.net/w/api.php');
define('WIKI_PHOTOS_ADDRESS', 'http://species-id.net/o/api.php');
define('WIKI_USERNAME', 'ZooKeys');
define('WIKI_PWD', '123123123');

define('TAXON_CACHE_SCRIPT_RECORDS_COUNT', 100);
define('TAXON_CACHE_SCRIPT_PROCESS_NAME', 'GenerateTaxonCache.php');

define('XLINK_NAMESPACE_URL', 'http://www.w3.org/1999/xlink');

define('PGDB_CMS_SRV', 'localhost');
define('PGDB_CMS_DB', 'TRIADA');
define('PGDB_CMS_USR', 'root');
define('PGDB_CMS_PASS', 'nadyadokoledasheinata');
define('PGDB_CMS_PORT', '');
define('DBTYPE_CMS', 'mysql');
define('DATE_SQL_FORMAT', '\'%Y-%m-%d\'');
define('MYSQL_CONNECTION_ENCODING', 'utf8');

define('KEYS_EXPORT_UPLOAD_URL', 'http://keycentral.identifylife.org/ws/Keys/Create?apiKey=');

define('EOL_EXPORT_TYPE', 1);
define('WIKI_EXPORT_TYPE', 2);
define('KEYS_EXPORT_TYPE', 3);
?>