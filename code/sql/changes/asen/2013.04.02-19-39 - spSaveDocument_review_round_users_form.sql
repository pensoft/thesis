...
ADD MORE QUESTIONS IN TYPE retgetdocumentreview AND IN spSaveDocument_review_round_users_form 
		...
		IF (pOper = 1) THEN
			...
			IF (lCheckVersion IS NULL) THEN
					...
					(document_review_round_user_id, decision_id, question1, question2, question3, question4, question5, question6, question7, question8, question9,
					 ...
					 notes_to_editor, disclose_name, publish_review)
					VALUES (lUsrId, pDecision_id, pQuestion1, pQuestion2, pQuestion3, pQuestion4, pQuestion5, pQuestion6, pQuestion7, pQuestion8, 
					pQuestion9, pQuestion10, pQuestion11, pQuestion12, pQuestion13, pQuestion14, pNotes_to_author, pNotes_to_editor, pDisclose_name, pPublish_review);
