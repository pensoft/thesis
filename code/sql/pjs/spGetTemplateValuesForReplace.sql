...
CREATE OR REPLACE FUNCTION pjs."spGetTemplateValuesForReplace"(pUid bigint, pDocumentId bigint, pEventTypeId int)
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION pjs."spGetTemplateValuesForReplace"(bigint, bigint, integer) OWNER TO postgres;
GRANT EXECUTE ON FUNCTION pjs."spGetTemplateValuesForReplace"(bigint, bigint, integer) TO postgres;
GRANT EXECUTE ON FUNCTION pjs."spGetTemplateValuesForReplace"(bigint, bigint, integer) TO iusrpmt;
GRANT EXECUTE ON FUNCTION pjs."spGetTemplateValuesForReplace"(bigint, bigint, integer) TO pensoft;
