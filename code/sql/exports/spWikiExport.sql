...
SELECT INTO lRes id, title, article_id, createuid, createdate, lastmod, xml, is_uploaded, upload_time, upload_has_errors, upload_msg, wiki_username_id, is_generated, has_results
FROM wiki_export 
WHERE id = lId;
