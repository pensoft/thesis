...
abstract class DBCnHelperAbstract {
	...
	protected function CustomSQLFunction($pFunctionName, $pFunctionArguments, $pFieldName, $pFieldType) {
		trigger_error("Unimplemented custom SQL Function: " . $pFunctionName . " for field " . $pFieldName . "!", E_USER_ERROR);
		exit();
	}
}
;
